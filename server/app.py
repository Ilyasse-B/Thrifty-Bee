...
def start_login():
    ...
    redirect_url = f'http://studentnet.cs.manchester.ac.uk/authenticate/?url=https://9710-31-205-0-5.ngrok-free.app/profile&csticket={cs_ticket}&version=3&command=validate'
