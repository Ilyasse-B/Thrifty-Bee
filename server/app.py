...
def start_login():
    ...
    redirect_url = f'http://studentnet.cs.manchester.ac.uk/authenticate/?url=https://84f8-86-9-200-131.ngrok-free.app/profile&csticket={cs_ticket}&version=3&command=validate'
